...
def test_driver_onboarding():
    ...
    login_res = requests.post(
        f"{BASE_URL}/users/login/driver/",
        json={"phone": driver_phone, "password": "password123"},
    )
    ...
    pending_res = requests.get(
        f"{BASE_URL}/drivers/admin/documents/pending/", headers=admin_headers
    )

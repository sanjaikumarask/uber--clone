...
class TestUserRegistration:
    ...
    def test_registration_duplicate_phone(self):
        ...
        User.objects.create_user(
            username="existing", phone="9876543210", password="pass123"
        )
...
class TestUserLogin:
    ...
    def setup_method(self):
        ...
        self.rider = User.objects.create_user(
            username="rider", phone="9876543210", password="testpass123", role="rider"
        )
        self.driver = User.objects.create_user(
            username="driver", phone="1234567890", password="testpass123", role="driver"
        )
    ...
    def test_driver_login_success(self):
        ...
        data = {"phone": "1234567890", "password": "testpass123"}
    ...
    def test_login_wrong_password(self):
        ...
        data = {"phone": "9876543210", "password": "wrongpassword"}

...
from apps.notifications.services.payloads import ride_assigned_payload
from apps.notifications.services.retry import get_retry_delay, should_retry


def test_payload_ride_assigned():
    data = {"driver_name": "Dave", "ride_id": 123, "vehicle": "Tesla"}

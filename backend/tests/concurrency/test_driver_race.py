...
class TestDriverAssignmentConcurrency:
    ...
    def test_multiple_drivers_accept_same_ride_race(self, api_client, ride, django_user_model):
        ...
        ride.driver = drivers[0] # Usually offered to one, but we simulate a 'glitch' or broadcast
        ride.save()
        ...
        error_count = len([r for r in results if r.status_code == status.HTTP_400_BAD_REQUEST])

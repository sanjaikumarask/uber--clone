...
class TestSystemResilience:
    ...
    def setup_method(self):
        ...
        self.user = User.objects.create_user(
            username="resilient_driver", role="driver", phone="+111"
        )
    ...
    def test_ledger_integrity_drift_detection(self, mock_alert):
        ...
        rider = User.objects.create_user(
            username="rider_audit", role="rider", phone="+222"
        )
        ride = Ride.objects.create(
            rider=rider, pickup_lat=0, pickup_lng=0, drop_lat=0, drop_lng=0
        )
        ...
        # Assert Alert fired
        assert any(
            call.kwargs.get("level") == "CRITICAL" for call in mock_alert.call_args_list
        )
    ...
    def test_ride_accept_race_condition(self):
        ...
        """
        rider = User.objects.create_user(
            username="rider_race", role="rider", phone="+333"
        )
        ride = Ride.objects.create(
            rider=rider,
        ...
        user2 = User.objects.create_user(
            username="driver_race_2", role="driver", phone="+444"
        )
    ...
    @patch("apps.notifications.services.alerts.send_critical_alert")
    def test_ghost_session_pruning_resilience(
        self, mock_alert, mock_remove_geo, mock_redis
    ):
        """

...
urlpatterns = [
    path(
        "ride-history/", DriverRideHistoryView.as_view(), name="driver-ride-history-new"
    ),
    # ── Driver self-service ──────────────────────────────────────────
    ...
    path(
        ...
        AdminDriverActionView.as_view(),
        name="admin-drivers-action",
    ),
    path(
        "admin/drivers/<int:driver_id>/",
        AdminDriverDetailView.as_view(),
        name="admin-driver-detail",
    ),
    path(
        "admin/drivers/<int:driver_id>/level/",
        AdminDriverLevelView.as_view(),
        name="admin-driver-level",
    ),
    path(
        "admin/drivers/<int:driver_id>/level-history/",
        AdminDriverLevelHistoryView.as_view(),
        name="admin-driver-level-history",
    ),
    path(
        "admin/drivers/<int:driver_id>/history/",
        AdminDriverRidesHistoryView.as_view(),
        name="admin-driver-rides",
    ),
    # ── Admin: Documents ─────────────────────────────────────────────
    path(
        "admin/documents/pending/",
        AdminPendingDocumentsView.as_view(),
        name="admin-docs-pending",
    ),
    path(
    ...
    path(
        "admin/documents/<int:doc_id>/approve/",
        AdminDocumentApprovalView.as_view(),
        name="admin-doc-approve",
    ),
]

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document_type', models.CharField(choices=[('LICENSE', 'Driving License'), ('RC', 'Registration Certificate'), ('INSURANCE', 'Vehicle Insurance'), ('AADHAAR', 'National ID')], max_length=20)),

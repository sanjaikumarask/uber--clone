...
def compute_score(stats: DriverStats, level: str) -> float:
    ...
    acc = stats.acceptance_rate / 100.0 # Normalized for 0-1 range to match weight style?
...
def admin_set_level(driver: Driver, new_level: str, admin_user, reason: str = "Manual admin update", duration_days: int = 7) -> None:

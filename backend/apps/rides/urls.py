...
urlpatterns = [
    ...
    path("", CreateRideView.as_view(), name="ride-list"),  # ✅ Supports POST /api/rides/
    # DRIVER
    ...
    path("<int:ride_id>/update-destination/", UpdateDestinationView.as_view(), name="ride-update-destination"),
    path("<int:ride_id>/fare-breakdown/", RideFareBreakdownView.as_view(), name="ride-fare-breakdown"),
